 ...
 * player. `wall` is not part of the room at all: it fills the missing cell of an L room's
 * box, is drawn as room wall and nothing ever enters it. Behaviour lives in `TILES`.
 */
export type Tile = 'floor' | 'obstacle' | 'rock' | 'hole' | 'thorn' | 'crusher' | 'wall';
