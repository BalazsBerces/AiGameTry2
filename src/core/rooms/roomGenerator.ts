...
import { missingCell, SHAPE_CELLS, type Cell, type Direction, type RoomKind, type RoomShape } from '../map/floorGenerator';
import { floodFill } from '../map/grid';
import { validateRoom, type Symmetry } from './roomValidator';
import type { Passive } from '../player/weaponModel';
...
/** Its split kills one segment and leaves two halves of 11. */
export const WORM_BOSS_LENGTH = 23;
