...
export function createZombie(scene: Phaser.Scene, x: number, y: number, champion = false): Enemy {
  ...
  return singlePartEnemy(scene, sprite, TUNING.zombie.hp * boost.hp, (ctx: EnemyContext) => {
