...
describe('generateRoom enemy mix per floor', () => {
  ...
  it('asks for more damage to clear a room on each later floor', () => {
    // Hit points: zombie 3, turret 4, worm 4 segments of 2, ghoul 4, crystal turret 4.
    const HP: Record<string, number> = { zombie: 3, turret: 4, worm: 8, ghoul: 4, crystalTurret: 4 };
...
describe('every archetype', () => {
  const ROSTER = [['zombie', 'turret'], ['ghoul', 'crystalTurret', 'worm'], ['zombie', 'turret', 'worm']];
